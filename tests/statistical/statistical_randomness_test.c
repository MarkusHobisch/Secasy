...
int main(void)
{
    ...
    if (test_frequency() > 0.01)
        passed++;
    if (test_runs() > 0.01)
        passed++;
    if (test_longest_run() > 0.01)
        passed++;
    if (test_serial() > 0.01)
        passed++;
    if (test_approximate_entropy() > 0.01)
        passed++;
    if (test_cumulative_sums() > 0.01)
        passed++;
    if (test_byte_distribution() > 0.01)
        passed++;
    if (test_autocorrelation() > 0.01)
        passed++;
    if (test_transitions() > 0.01)
        passed++;
