...
void exportResults(TestResults preimageResults, TestResults secondPreimageResults)
{
    ...
    double preimageSecurityBits = preimageResults.found ? -log2(preimageSuccessRate) : log2(preimageResults.attempts);
    ...
    double secondPreimageSecurityBits = secondPreimageResults.found ? -log2(secondPreimageSuccessRate) : log2(secondPreimageResults.attempts);
