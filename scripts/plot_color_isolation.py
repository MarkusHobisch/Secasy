...
RESULTS = {
    "Baseline\n(mixed: ADD/SUB/XOR/AND/OR/INVERT)": {
        "bins": [0,0,0,0,0,0,0,0,287,12137,12874,302,0,0,0,0,0,0,0,0],
        "mean": 50.0, "std": 2.2,
    },
    "ADD only": {
        "bins": [0,0,5,7,9,18,16,35,319,12063,12828,300,0,0,0,0,0,0,0,0],
        "mean": 49.9, "std": 2.5,
    },
    "SUB only": {
        "bins": [0,0,0,0,0,1,6,16,351,12226,12583,404,9,3,1,0,0,0,0,0],
        "mean": 50.0, "std": 2.3,
    },
    "XOR only": {
        "bins": [0,0,19,77,115,148,211,248,843,11961,11680,298,0,0,0,0,0,0,0,0],
        "mean": 49.1, "std": 4.4,
    },
    "AND only": {
        "bins": [125,82,116,147,217,258,375,544,1744,10843,10381,755,12,1,0,0,0,0,0,0],
        "mean": 47.9, "std": 7.3,
    },
    "OR only": {
        "bins": [586,116,211,386,395,655,917,1867,3664,5848,7259,2656,875,150,14,1,0,0,0,0],
        "mean": 45.5, "std": 12.0,
    },
    "INVERT only": {
        "bins": [4,42,110,118,103,198,237,709,3058,8355,9747,2634,281,4,0,0,0,0,0,0],
        "mean": 48.8, "std": 6.6,
    },
}
